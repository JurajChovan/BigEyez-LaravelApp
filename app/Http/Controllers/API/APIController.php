...
class APIController extends BaseController  {
    ...
    */
    ...
    /* ------------------------------------------------------------------------------------------------------------ */
    /* ------------------------------------------------------------------------------------------------------------ */
    // testovacia API funkcia pre neautentifikovaného (neprihláseného) používate¾a (GET, http://127.0.0.1:8000/api/NoAuthInfo):
    /* JCHO: vypíše API aj pre nehláseneného používate¾a: */
    ...
    /* ------------------------------------------------------------------------------------------------------------ */
    // testovacia API funkcia pre autentifikovaného (prihláseného) používate¾a (GET, http://127.0.0.1:8000/api/AuthInfo):
    /* JCHO: vypíše API len pre prihláseneného používate¾a: */
    ...
    */
    ...
    /* ------------------------------------------------------------------------------------------------------------ */
    /* JCHO: vypíše databázový test info len pre prihláseneného používate¾a: */
